    ...
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-20">
      ...
      <div className="container-padding mx-auto relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="text-sm text-dark-300">Rólunk</span>
          </motion.div>
          ...
          >
            Küldetésünk az{" "}
            <span className="text-gradient">értékesítés demokratizálása</span>
          </motion.h1>
          ...
          >
            Hiszünk abban, hogy minden növekvő vállalkozás megérdemli a hozzáférést 
            azokhoz a high-end értékesítési eszközökhöz és stratégiákhoz, amelyeket 
            korábban csak a legnagyobb vállalatok engedhettek meg maguknak.
          </motion.p>
        </div>
      </div>
    </section>
